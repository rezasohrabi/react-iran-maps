  ...
  return (
    <section className="bg-white rounded-lg shadow-lg p-6">
      ...
      <p className="text-gray-600 mb-4">
        در این مثال، نام استان‌ها با املاهای مختلف نوشته شده‌اند (مثل
        "اذربایجان" به جای "آذربایجان"، "چهار محال" به جای "چهارمحال"،
        "کهکیلویه" به جای "کهگیلویه" و ...) ولی به درستی نمایش داده می‌شوند.
      </p>
      <div className="bg-blue-50 border-r-4 border-blue-400 p-4 mb-4">
        <h3 className="font-semibold text-blue-800 mb-2">
          نمونه‌هایی از املاهای مختلف:
        </h3>
